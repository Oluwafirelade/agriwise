            ...
            <div className="space-y-1.5 animate-in fade-in slide-in-from-top-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-background border border-border rounded-xl py-2.5 pl-10 pr-4 text-sm outline-none focus:ring-2 focus:ring-primary/50 transition-shadow disabled:opacity-50"
                />
              </div>
            </div>
          )}
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder="••••••••"
                className="w-full bg-background border border-border rounded-xl py-2.5 pl-10 pr-10 text-sm outline-none focus:ring-2 focus:ring-primary/50 transition-shadow disabled:opacity-50"
              />
              <button
                type="button"
                disabled={isFormDisabled}
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors p-1 disabled:opacity-50"
